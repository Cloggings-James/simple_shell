...
/**
 * _getenv - gets the value of the global variables
 * @name: name of the global variables
 ...
 * @head: pointer to pointer to our linked lists
 * @str: pointer to string in previous first nodes
 * Return: address of the new element/nodes
 */
